...
namespace Rota_Selenium
{
    internal class Program
    {
        ...
        {
            string artista; Console.Write("Inserisci nome dell'artista: "); artista = Console.ReadLine(); IWebDriver driver = new ChromeDriver(); driver.Navigate().GoToUrl($"https://open.spotify.com/search/{artista}/artists");
